...
import {find, pathOr, propEq, isNil, isEmpty} from 'ramda'


const ClosedCustomsList = ({match, getCustomsList}) => {
    ...
    useEffect(() => {
        getCustomsList(moment(from).format("YYYY-MM-DD"), moment(to).format("YYYY-MM-DD"), "")
    },[from, to])
    ...
    return (
      <div className="map-wrapper">
        <PageTitleBar title={<IntlMessages id="sidebar.closed-customs" />} match={match} />
        <RctCollapsibleCard>
