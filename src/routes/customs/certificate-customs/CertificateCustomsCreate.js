...
const CertificateCustomsCreate = ({match, history, editCustomsDetail}) => {
    const {id} = useParams()
    ...
    const handleSubmit = e => {
        ...
        editCustomsDetail(id, list, history, "/app/customs/certificate-customs")
    };
