...
const ReadyCustomsList = ({match, getCustomsList}) => {
    ...
    useEffect(() => {
        getCustomsList(moment(from).format("YYYY-MM-DD"), moment(to).format("YYYY-MM-DD"), "готовые для оформления")
    },[from, to])
    ...
    return (
      <div className="map-wrapper">
        <PageTitleBar title={<IntlMessages id="sidebar.ready-customs" />} match={match} />
        <RctCollapsibleCard>
